...
(function (blocks, i18n, element, editor, components) {
     ...
     */
    registerBlockType('md/multipurpose-block', {
        ...
        edit(props){
            ...
            return [
                (
                    ...
                    <InspectorControls>
                        <div className="custom-inspactor-setting">
                            <PanelBody title={ __('Page Tag settings ') } initialOpen={ false }>
                                <Button
                                    className={ElementTag === 'header' ? 'button has-tooltip active' : 'button has-tooltip'}
                                    onClick={onSelectTagType}
                                    value="header">
                                    {__('Header')}
                                </Button>
                                <Button
                                    className={ElementTag === 'section' ? 'button has-tooltip active' : 'button has-tooltip'}
                                    onClick={onSelectTagType}
                                    value="section">
                                    {__('Section')}
                                </Button>
                ...
                (
                    <ElementTag className={classes} style={ style }>
                        <InnerBlocks/>
                    </ElementTag>
                ),
            ]
